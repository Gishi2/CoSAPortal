...
<head>
    <meta charset="utf-8">
    <title>CoSA Portal | Admin Management</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <li>
         ...
         <li class="profile">
         <div class="name-job">
            <div class="profile_name" style="color: #8D8E92">
                <?php 
  ...
  <!-- Navbar End -->
    ...
    <div class="container-xl px-4 mt-4">
        <nav class="nav nav-borders">
            ...
            <a class="nav-link" href="user_registered.php" target="__blank">User Registered</a>
