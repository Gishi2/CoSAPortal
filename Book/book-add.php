        ...
        <div class="main-page">
            <div class="product-edit-container">
                ...
                <div class="product-title">
                    ...
                    <input name="title" id="title" type="text" placeholder="Title" size="large" resize="none">
                </div>
                <div class="product-subject">
                    ...
                    <input name="subject" id="subject" type="text" placeholder="Subject, e.g. MAT210" size="large" resize="none">
                </div>
